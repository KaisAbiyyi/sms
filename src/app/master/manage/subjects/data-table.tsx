        ...
        <div className="flex flex-col gap-8">
            <div className="flex gap-4">
                <div className="w-2/12 gap-2 p-4 rounded-lg shadow bg-slate-50">
                    <span className="text-xs font-semibold uppercase text-slate-500">Total subjects registered</span>
                ...
                <div className="flex w-10/12 gap-4 p-4 rounded-lg shadow bg-slate-50">
                    <div className="flex flex-col w-full gap-2">
                        <label htmlFor="searchSubjects" className="text-xs font-semibold uppercase text-slate-500">What are you looking for?</label>
                        <input
                            type="text"
                            name="searchSubjects"
                            id="searchSubjects"
            ...
            <div className="flex flex-col overflow-hidden rounded-lg shadow bg-slate-50">
                <div className="flex justify-between p-2">
                    <h1 className="font-semibold text-md text-slate-700">List of all Subjects</h1>
                    ...
                    <Table>
                        <TableHeader>
                            {table.getHeaderGroups().map((headerGroup) => (
                                <TableRow key={headerGroup.id} className="border bg-slate-100 border-slate-100 hover:bg-slate-200">
